...
static const pinCfg_t outputCfg[] = { 
	{ vioLED0, GPIO_PIN_ID_PORTF(6), ARM_GPIO_PULL_NONE, VIO_ACTIVE_HIGH },
	{ vioLED1, GPIO_PIN_ID_PORTB(4), ARM_GPIO_PULL_NONE, VIO_ACTIVE_HIGH },
	{ vioLED2, GPIO_PIN_ID_PORTG(7), ARM_GPIO_PULL_NONE, VIO_ACTIVE_HIGH },
	{ vioLED3, GPIO_PIN_ID_PORTI(0), ARM_GPIO_PULL_NONE, VIO_ACTIVE_HIGH },
	{ vioLED4, GPIO_PIN_ID_PORTH(6), ARM_GPIO_PULL_NONE, VIO_ACTIVE_HIGH },
	{ vioLED5, GPIO_PIN_ID_PORTI(3), ARM_GPIO_PULL_NONE, VIO_ACTIVE_HIGH },
	{ vioLED6, GPIO_PIN_ID_PORTA(15), ARM_GPIO_PULL_NONE, VIO_ACTIVE_HIGH },
	{ vioLED7, GPIO_PIN_ID_PORTA(8), ARM_GPIO_PULL_NONE, VIO_ACTIVE_HIGH }
};
#endif
...
//  signal,     pin,                   pull resistor,      active state
  { vioBUTTON0, GPIO_PIN_ID_PORTF(10), ARM_GPIO_PULL_NONE, VIO_ACTIVE_HIGH },
	{ vioBUTTON1, GPIO_PIN_ID_PORTF(9), ARM_GPIO_PULL_NONE, VIO_ACTIVE_HIGH },
	{ vioBUTTON2, GPIO_PIN_ID_PORTF(8), ARM_GPIO_PULL_NONE, VIO_ACTIVE_HIGH },
	{ vioBUTTON3, GPIO_PIN_ID_PORTF(7), ARM_GPIO_PULL_NONE, VIO_ACTIVE_HIGH }
};
#endif
